...
export default function Hero() {
  return (
    <section id="top" className="relative min-h-svh pt-24 md:pt-28">
      <div className="shell">
        {/* top meta row */}
        <motion.div
          custom={0}
        ...
        <div className="mt-10 grid grid-cols-1 gap-8 rule-t pt-8 md:mt-14 md:grid-cols-12">
          ...
          >
            <p className="text-lg leading-relaxed text-ink-2">{profile.lede}</p>
        ...
        <motion.a
          ...
          animate={{ opacity: 1 }}
          transition={{ delay: 1 }}
          className="meta mt-10 flex items-center gap-2 pb-8 text-ink-3"
        >
          <motion.span
            animate={{ y: [0, 5, 0] }}
